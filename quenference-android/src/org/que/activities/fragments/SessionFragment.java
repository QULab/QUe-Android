...
/**
 * Represents the Fragment for the session view.
 *
...
public class SessionFragment extends FavoriteMenuFragment {
  ...
  /**
   * The tag for the session view.
   */
  private static final String TAG_SESSIONVIEW = "sessionview_tag";
  
  /**
   * The session entity which contains the session informations.
   */
  private SessionEntity session;
  
  /**
   * The Textviews which shows the session informations.
   */
