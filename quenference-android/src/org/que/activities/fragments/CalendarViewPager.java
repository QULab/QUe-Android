 ...
 */
public class CalendarViewPager extends Fragment {
  ...
  public void onCreate(Bundle savedInstanceState) {
    ...
    View root = inflater.inflate(R.layout.fragment_calendar__viewpager, container, false);
  ...
  public class MyAdapter extends FragmentPagerAdapter {
    ...
    public Fragment getItem(int position) {
      String[] conferenceDates = getResources().getStringArray(R.array.Conference_Dates);
      String confDayDate = conferenceDates[position];
      return CalendarBookedFragment.newInstance(confDayDate);
    }
    ...
    public CharSequence getPageTitle(int position) {
      ...
      try {
        ...
        Log.e(CalendarViewPager.class.getName(), "ParseException", e);
      }
